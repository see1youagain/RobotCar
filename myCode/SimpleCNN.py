...
class IdentifyPic():
    def __init__(self):
        ...
        template_B = []
        template_C = []
        folder_pathA = 'D:/RobotCar/myCode/alphabet/A'
        filesA = os.listdir(folder_pathA)
        folder_pathB = 'D:/RobotCar/myCode/alphabet/B'
        filesB = os.listdir(folder_pathB)
        folder_pathC = 'D:/RobotCar/myCode/alphabet/C'
    ...
    def getPic(self):
        ...
        hx, image = cap.read()
        # hx=True
        # image = cv2.imread("D:/RobotCar/myCode/alphabet/aera8.jpg")
        ...
        if(len(locations_A) + len(locations_B)  + len(locations_C) >=3):
            ...
            aera1_crop = image
            cv2.imwrite("D:/RobotCar/myCode/alphabet/aera12.jpg", aera1_crop)
            # 绘制结果
