...
class MoveBaseSquare():
    ...
    def __init__(self):
        ...
        euler_angles = (pi/2, pi/2 ,pi/2,-pi/2, -pi/2, -pi/2,-pi/2,0,pi,pi,pi/2,-pi/2,0,-pi/2)
        ...
        # 一车
        self.waypoints = list()
        self.waypoints.append(Pose(Point(1.355, 1.850, 1.553), quaternions[0]))  # //C
        ...
        self.waypoints.append(Pose(Point(-1.860, 1.381, -1.586), quaternions[4]))  # //3
        ...
        self.waypoints.append(Pose(Point(-1.741, 2.330, - 1.564), quaternions[6]))  # //1
        ...
        self.waypoints.append(Pose(Point(-0.6,- 0.108, - 0.507), quaternions[12]))  # 取药区到起点的必经点
        self.waypoints.append(Pose(Point(-1.840, 0.1, -1.542), quaternions[13]))  # 仓库
