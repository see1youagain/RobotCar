...
class IdentifyPic():
    ...
    def getPic(self):
        ...
        for i in range(len(template_A)):
            ...
            if len(locations_ATmp) >= len(locations_A) and len(locations_BTmp) >= len(locations_B) and len(locations_CTmp) >= len(locations_C):
                locations_A = locations_ATmp
                locations_B = locations_BTmp
                locations_C = locations_CTmp
