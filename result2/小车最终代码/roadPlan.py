    ...
    def receiveMessage(self,msg):
        ...
        if (len(data) == 10):
            ...
            if(len(window)>0):
                ...
                if self.list[window[0]]=='C' and self.C> 0:
                    rospy.sleep(1)
                    self.roadPlan_pub.publish('w:{}|n:{}'.format(window[0], num[0]))
                elif self.list[window[0]]=='A' and self.A> 0:
                    rospy.sleep(1)
                    self.roadPlan_pub.publish('w:{}|n:{}'.format(window[0], num[0]))
                elif self.list[window[0]]=='B' and self.B> 0:
                    rospy.sleep(1)
                    self.roadPlan_pub.publish('w:{}|n:{}'.format(window[0], num[0]))
